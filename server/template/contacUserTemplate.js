export const getUserEmailHtml = (firstName) => `
<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="utf-8">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.7; color: #94a3b8;">
                Merci de nous avoir contactés. Nous avons bien reçu votre message et nous vous répondrons dans les meilleurs délais.
              </p>
              ...
              <div style="background-color: #0f172a; border-left: 3px solid #3b82f6; padding: 16px 20px; border-radius: 0 8px 8px 0; margin: 28px 0;">
                ...
                <p style="margin: 6px 0 0; font-size: 13px; color: #64748b;">
                  Notre équipe traitera votre demande très prochainement.
                </p>
              </div>
